 ...
 * 
 */
export default class TestNestedAccordianPicker extends Component {
    constructor(props) {
        super(props);
        ...
        console.log(`TestNestedAccordianPicker.constructor(): `);
    }
    ...
    getItemFromIndex = (indicesArr, isSelected) => {
        console.log(`TestNestedAccordianPicker.getItemFromIndex(): Trying to get item from index: ${indicesArr}`);
        ...
        // console.log(`TestNestedAccordianPicker.getItemFromIndex(): this.state.dataArray: ${Object.keys(this.state.dataArray)}`);
        ...
        for (let iIndices in indicesArr) {
            ...
            console.log(`TestNestedAccordianPicker.getItemFromIndex(): ITEM: Obj[${curIndex}]: ${name}`);
            ...
            if (tmpObjArr != null) {
                ...
                if (objChildren != null && objChildren.length > 0) {
                    console.log(`TestNestedAccordianPicker.getItemFromIndex(): cur Item: Obj[${curIndex}]: ${name}`);
                    // Set our tmp obj to the chilren for the next loop
                    tmpObjArr = objChildren;
                }
                // If there arent children, then this is a leaf
                else {
                    console.log(`TestNestedAccordianPicker.getItemFromIndex(): ITEM FOUND: Obj[${curIndex}]: ${name}`);
                    item = tmpObjArr;
                ...
                console.log(`TestNestedAccordianPicker.getItemFromIndex(): Obj[${curIndex}]: tmpObjArr == null`);

            }

        }
        // console.log(`TestNestedAccordianPicker.getItemFromIndex(): FOUND Item: ${name}`);
        return item;
    }
    ...
    */
    onItemSelectedHandler = (item) => {
        ...
        console.log(`TestNestedAccordianPicker.onItemSelectedHandler(): Selected Item: ${item[this.state.nestedVarTitleName]} isSelected: ${item.isSelected} hasParent: ${parent != null}`);
        ...
        if (item.isSelected) {
            ...
            if (this.state.maxSelectAmount > 0 && this.state.selectedItems.length == this.state.maxSelectAmount) {
                console.log(`TestNestedAccordianPicker.onItemSelectedHandler(): ${item[this.state.nestedVarTitleName]} Exceeded MAX select amount of ${this.state.maxSelectAmount}.  Unselecting: ${this.state.selectedItems[0]}`);
                this.getItemFromIndex(this.state.selectedItems[0], false);
            }

            while (parent != null) {
                console.log(`TestNestedAccordianPicker.onItemSelectedHandler(): Setting Parent: ${parent[this.state.nestedVarTitleName]} isIntermediate = true`);
            ...
            while (parent != null) {
                console.log(`TestNestedAccordianPicker.onItemSelectedHandler(): Setting Parent: ${parent[this.state.nestedVarTitleName]} isIntermediate = false`);
    ...
    _renderHeader = (item, expanded) => {
        if (item != null) {
            // console.log(`TestNestedAccordianPicker._renderHeader(): ${item[this.state.nestedVarTitleName]} isSelected: ${item.isSelected}`)
            // console.log(`TestNestedAccordianPicker._renderHeader(): Item: ${JSON.stringify(item)}`)
            ...
            if (item.checkBoxStyle != null) {
                // console.log(`TestNestedAccordianPicker._renderHeader(): Item: ${item[this.state.nestedVarTitleName]} CheckBoxStyle: ${JSON.stringify(item.checkBoxStyle)}`)
            ...
            if (item.isIntermediate) {
                ...
                console.log(`TestNestedAccordianPicker._renderHeader(): ${item[this.state.nestedVarTitleName]} Setting INTERMEDIATE`)
            }
            else if (item.isSelected) {
                iconSource = this.state.checkboxCheckedSource;
                console.log(`TestNestedAccordianPicker._renderHeader(): ${item[this.state.nestedVarTitleName]} Setting CHECKED`)

            }

            // console.log(`TestNestedAccordianPicker._renderHeader(): ${item[this.state.nestedVarTitleName]} checkBoxStyle: ${JSON.stringify(checkBoxStyle)}`)
            ...
            console.log(`TestNestedAccordianPicker._renderHeader(): ERROR Item was NULL`)

        }
    }
    _renderContent = (item) => {

        console.log(`TestNestedAccordianPicker._renderContent(): Top ${item[this.state.nestedVarTitleName]}`);
        if (item != null && item[this.state.nestedVarName] != null) {
            ...
            for (let iChild in itemsChildren) {
                ...
                child.parent = item;
                console.log(`TestNestedAccordianPicker._renderContent(): Child: ${child[this.state.nestedVarTitleName]} Parent: ${item[this.state.nestedVarTitleName]}`);
            }
            ...
            console.log(`TestNestedAccordianPicker._renderContent(): Rendering Accordian for children of: ${item[this.state.nestedVarTitleName]}`);
            ...
            console.log(`TestNestedAccordianPicker._renderContent(): ${item[this.state.nestedVarTitleName]}`);
    ...
    render = () => {
        if (this.state.dataArray != null) {
            ...
            // console.log(`TestNestedAccordianPicker.render(): Rendering this.state.dataArray: ${this.state.dataArray}`);
            return (
                <Container>
                    <Header />
            ...
            console.log(`TestNestedAccordianPicker.render(): Rendering this.state.dataArray: NULL`);
            return null
        }
    }

    renderAccordian = (dataArr) => {
        console.log(`TestNestedAccordianPicker.renderAccordian(): dataArr: ${dataArr}`);
    ...
    printDataArray = (dataArr) => {
        ...
        console.log(`TestNestedAccordianPicker.printDataArray(): Arr: ${resultStr}`);
    }
    ...
    printEntireDataArray = (dataArr) => {
        ...
        console.log(`TestNestedAccordianPicker.printEntireDataArray(): Arr: ${resultStr}`);
    }
    ...
    printItemsSubArray = (item) => {
        if (item[this.state.nestedVarName] != null) { // && item[this.state.nestedVarName].length > 0) {
            ...
            console.log(`TestNestedAccordianPicker.printItemsSubArray(): Arr: ${resultStr}`);
            ...
            console.log(`TestNestedAccordianPicker.printItemsSubArray(): item: ${item[this.state.nestedVarTitleName]} has NO sub array`);

            console.log(`TestNestedAccordianPicker.printItemsSubArray(): item: ${Object.keys(item)} has NO sub array`);
        }
    }
